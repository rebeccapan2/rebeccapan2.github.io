...
## Printing Settings
The TPU used could not exceed 220 degrees Celsius so the bed temperature was set at 210 degrees Celsius maximum. The print was done using a 0.6 mm nozzle and the Voron 3000. 
